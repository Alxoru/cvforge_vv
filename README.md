...
✨ Что внутри?
🧩 Модульные процессоры — собирай пайплайны из готовых блоков
🔄 Любые источники — вебка, RTSP, видео, папка с картинками
🎨 Color-safe — фреймворк помнит BGR/RGB/GRAY за тебя
📊 Мониторинг из коробки — FPS, latency, размер кадра
🎬 Запись в один клик — VideoWriter прямо в пайплайне
